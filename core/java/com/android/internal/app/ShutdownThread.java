...
public final class ShutdownThread extends Thread {
    ...
    private static boolean mShutdownAnimation = true;
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        mShutdownAnimation = (Settings.System.getInt(context.getContentResolver(),
    ...
    public void run() {
        ...
        if (mShutdownAnimation) {
            Log.i(TAG, "Disable shutdown animation for next boot...");
            SystemProperties.set( "persist.sys.shutdownenable","0");
        }
